...
class CunningDocumentScannerPlugin :
    ...
    // / Camera path: fallback scanner (system camera + manual corner cropper), same UI as gallery crop.
    private fun startScan(
        noOfPages: Int,
        @Suppress("UNUSED_PARAMETER") isGalleryImportAllowed: Boolean,
        @Suppress("UNUSED_PARAMETER") scannerMode: Int,
        @Suppress("UNUSED_PARAMETER") asPdf: Boolean,
    ) {
